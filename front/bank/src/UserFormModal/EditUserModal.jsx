...
const EditUserModal = ({ open, onClose, user = {}, onUpdateUser }) => {
    ...
    const validate = () => {
        ...
        if (formData.is_blocked === '') newErrors.is_blocked = 'Статус блокировки обязателен';
        return newErrors;
    };
        ...
        >
            <Paper style={{ padding: 20, margin: 20 }}>
                ...
                <TextField
                    ...
                    label="Заблокирован"
                    name="is_blocked"
                    value={formData.is_blocked || false}
                    onChange={handleChange}
                    fullWidth
                    error={!!errors.is_blocked}
                    helperText={errors.is_blocked}
                >
